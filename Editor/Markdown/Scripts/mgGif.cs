...
public class MarkdownImage : ICloneable
{
    public int Width;
    public int Height;
    ...
    public MarkdownImage(MarkdownImage img)
    {
        Width = img.Width;
        Height = img.Height;
        Delay = img.Delay;
...
public class Decoder : IDisposable
{
    ...
    public MarkdownImage NextImage()
    {
